...
<div>
  ...
  <h2 class="font-bold text-4xl">Login</h2>
   <div>
      ...
      <input class="pl-4 rounded-md pr-16 py-2 mt-3" type="email" id="email" placeholder="Wpisz email" name="email">
    </div>
    <div>
      <label class="block text-xl mt-6" for="pwd">Hasło:</label>
      <input class="pl-4 rounded-md pr-16 py-2 mt-3" type="password" id="pwd" placeholder="Wpisz hasło" name="pwd">
    </div>
    <input class="bg-indigo-700 text-white px-4 py-2 font-semibold rounded-md mt-6" type="submit" name="submit" value="Submit">
  </div>
  </form>
</div>
</body>
